...
def gpt_grounded_sam(image_nname, ex_num, question, bi):
    ...
    Question: {question} 
    """
    OPEN_AI_API_KEY =  "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"
    ...
    OUTPUT_DIR = f"./_garbage/EX_{ex_num}/{IMAGE_NAME}"
    ...
    f=open("./txt_s/results_bboxes2.txt", 'a')
    for r in result:
        f.write(f"{str(bi)}   {str(r)}\n")
    f.close()
