...
SOURCE_PATH = os.path.join("./outputs_image_name_2", IMAGE_NAME, OBJECT_NAME)

OUTPUT_BASE_DIR = "./outputs_inpainting"

OUTPUT_DIR=os.path.join(OUTPUT_BASE_DIR, IMAGE_NAME, OBJECT_NAME)
...
# paste
bbox = [170 , 120 , 335 , 224] # img_0 tv_0 bigger
